...
/***/ (function(module, exports) {
	...
	PENDING_LIST_URL = URL_BASE + "db/getPendingEntries", CURRENT_LIST_URL = URL_BASE + "db/getDatabaseEntries", APPROVE_URL = URL_BASE + "db/approve", REMOVE_URL = URL_BASE + "db/deleteFromRemote", ADD_URL = URL_BASE + "db/addToRemote", EDIT_URL = URL_BASE + "db/edit";
	...
	ReactDOM.render(React.createElement(IceBox, { pendingListUrl: PENDING_LIST_URL, pollInterval: 3 * 60 * 1000 }), document.getElementById('content'));
