...
/***/ (function(module, exports, __webpack_require__) {
	...
	const Bar = _react2.default.createClass({
	  ...
	  propTypes: {
	    ...
	    mouseover: _react.PropTypes.function,
	    mouseout: _react.PropTypes.function
	  },
...
/***/ (function(module, exports, __webpack_require__) {
	...
	const FrequencyBarChart = _react2.default.createClass({
	  ...
	  createFrequencyBarChart() {
	    ...
	    const formatPercent = _d2.default.format(".0%");

	    const x = _d2.default.scale.ordinal().rangeRoundBands([0, width], .1);

	    const y = _d2.default.scale.linear().range([height, 0]);

	    const xAxis = _d2.default.svg.axis().scale(x).orient("bottom");

	    const yAxis = _d2.default.svg.axis().scale(y).orient("left");
	    ...
	    const svg = _d2.default.select("#graph1").append("svg").attr("width", width + margin.left + margin.right).attr("height", height + margin.top + margin.bottom).append("g").attr("transform", "translate(" + margin.left + "," + margin.top + ")");
	    ...
	    svg.append("g").attr("class", "x axis").attr("transform", "translate(0," + height + ")").call(xAxis).selectAll("text").style("text-anchor", "end").attr("dx", "-.8em").attr("dy", ".15em").attr("transform", "rotate(-50)");;

	    svg.append("g").attr("class", "y axis").call(yAxis).append("text").attr("transform", "rotate(-90)").attr("y", 6).attr("dy", ".71em").style("text-anchor", "end").text("Number of Occurences");
	  ...
	  renderBarGraphs() {
	    return _react2.default.createElement(
	      'div',
	      null,
	      this.state.data.map(d => _react2.default.createElement(_Bar2.default, {
	        x: d => {
	          return x(d.text);
	        },
	        width: x.rangeBand(),
	...
	ReactDOM.render(_react2.default.createElement(FrequencyBarChart, { mouseover: () => {}, mouseout: () => {} }), document.getElementById('ingredient_frequency'));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!../../node_modules/css-loader/index.js!./ingredient_frequency_bar.css", function() {
				var newContent = require("!!../../node_modules/css-loader/index.js!./ingredient_frequency_bar.css");
